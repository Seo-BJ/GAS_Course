...
void AAuraPlayerController::SetupInputComponent()
{
	...
	AuraEnhancedInputComponent->BindAbilityActions(InputConfig, 
	this,
...
{
	GEngine->AddOnScreenDebugMessage(1, 3.f, FColor::Red, FString("Move"));
...
{
	return AuraAbilitySystemComponent = AuraAbilitySystemComponent 
		== nullptr ? Cast<UAuraAbilitySystemComponent>(UAbilitySystemBlueprintLibrary::GetAbilitySystemComponent(GetPawn<APawn>())) : AuraAbilitySystemComponent;
}
